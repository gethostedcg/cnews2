        ...
        <small> by: </small>
         ...
         <small>{user && (
          <Link href={`/user/${user._id}`}>
            ...
            {/*  <img width="10" height="10" style={{ borderRadius: '50%', objectFit: 'cover', marginRight: '0.3rem' }} src={user.profilePicture || defaultProfilePicture(user._id)} alt={user.name} />*/}
             <b>{user.name}</b>
            </a>
